var kana = {
	// 'a' : { 'ã‚': 'a', 'ã„': 'i', 'ã†': 'u', 'ãˆ': 'e', 'ãŠ': 'o'},
        ...
        'j': {'جَ': 'ja', 'جِ': 'ji', 'جُ': 'jo'},
        'hh': {'حَ': 'ḥa', 'حِ': 'ḥi', 'حُ': 'ḥo'},
        'kh': {'خَ': 'kha', 'خِ': 'khi', 'خُ': 'kho'},
        'd': {'دَ': 'da', 'دِ': 'di', 'دُ': 'do'},
        'th': {'ذَ': 'tha', 'ذِ': 'thi', 'ذُ': 'tho'},
        'r': {'رَ': 'ra', 'رِ': 'ri', 'رُ': 'ro'},
        'z': {'زَ': 'za', 'زِ': 'zi', 'زُ': 'zo'},
        's': {'سَ': 'sa', 'سِ': 'si', 'سُ': 'so'},
        'ss': {'صَ': 'ṣa', 'صِ': 'ṣi', 'صُ': 'ṣo'},
        'sh': {'شَ': 'sha', 'شِ': 'shi', 'شُ': 'sho'},
        'dh': {'ضَ': 'ḍa', 'ضِ': 'ḍi', 'ضُ': 'ḍo'},
        'tt': {'طَ': 'ṭa', 'طِ': 'ṭi', 'طُ': 'ṭo'},
        'dhz': {'ظَ': 'ẓa', 'ظِ': 'ẓi', 'ظُ': 'ẓo'},
        'aa': {'عَ': 'ʿa', 'عِ': 'ʿi', 'عُ': 'ʿo'},
        'gh': {'غَ': 'gha', 'غِ': 'ghi', 'غُ': 'gho'},
        'f': {'فَ': 'fa', 'فِ': 'fi', 'فُ': 'fo'},
        'qh': {'قَ': 'qa', 'قِ': 'qi', 'قُ': 'qo'},
        'k': {'كَ': 'ka', 'كِ': 'ki', 'كُ': 'ko'},
        'l': {'لَ': 'la', 'لِ': 'li', 'لُ': 'lo'},
        'm': {'مَ': 'ma', 'مِ': 'mi', 'مُ': 'mo'},
        'n': {'نَ': 'na', 'نِ': 'ni', 'نُ': 'no'},
